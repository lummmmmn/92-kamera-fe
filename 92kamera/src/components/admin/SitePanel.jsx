      ...
      <div style={{ display: "grid", gridTemplateColumns: isMobile ? "1fr" : "1fr 1fr", gap: 18 }}>
        ...
        <div>
          ...
          <div style={{ background: CARD2, border: `1px solid ${BR2}`, borderRadius: 14, padding: 22, marginBottom: 14 }}>
            <div style={{ color: TXT, fontWeight: 600, marginBottom: 6, fontSize: 13 }}>🔗 Link mạng xã hội (5 logo đầu trang)</div>
            ...
            {[
              ...
              { k: "gmap", label: "Google Maps", ph: "https://maps.app.goo.gl/xxxx (link vị trí shop)", svg: <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M21 10c0 6-9 12-9 12s-9-6-9-12a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg> },
            ].map(({ k, label, svg, ph }) => {
