...
function useFavicon() {
  useEffect(() => {
    ...
    const svg = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32"><defs><radialGradient id="ball" cx="42%" cy="35%" r="58%"><stop offset="0%" stop-color="#ff4400"/><stop offset="40%" stop-color="#dd1100"/><stop offset="100%" stop-color="#3a0000"/></radialGradient><radialGradient id="shine" cx="38%" cy="28%" r="35%"><stop offset="0%" stop-color="#ffaa88" stop-opacity="0.5"/><stop offset="100%" stop-color="#ff2200" stop-opacity="0"/></radialGradient></defs><circle cx="16" cy="16" r="14" fill="url(#ball)"/><circle cx="16" cy="16" r="14" fill="url(#shine)"/></svg>`;
